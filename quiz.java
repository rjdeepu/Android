...
public class MainActivity extends AppCompatActivity {
    ...
    public void submitQuiz(View view) {
        ...
        CheckBox lengthInSp = (CheckBox) findViewById(R.id.length_in_sp);
        boolean selectedLengthInSp = lengthInSp.isChecked();
        ...
        if (selectedNoneOfTheAbove) {
            score = score + 1;
        } else if (selectedTextInDp) {
            score = score + 0;
        } else if (selectedLengthInSp) {
            score = score + 0;
        } else {
            score = score + 0;
        }
